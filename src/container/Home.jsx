        ...
        <div className="flex-1 min-h-screen max-h-screen overflow-y-scroll h-full flex flex-col items-start justify-start px-4 md:px12 py-4 md:py-12">
            ...
            <div className="w-full flex items-center justify-between gap-3">
                ...
                <div className="bg-secondary w-full px-4 py-3 rounded-md flex items-center justify-center gap-3">
                    ...
                    <input
                        type="text"
                        className="flex-1 px-4 py-1 text-xl bg-transparent outline-none border-none text-primaryText placeholder:text-gray-600 capitalize" placeholder="search here..." />
                </div>
                {/* profil section */}
                {!user && (
                    <motion.div
                    ...
                    >
                        <Link
                            to={"/home/auth"}
                            className="bg-emerald-500 px-6 py-2 rounded-md text-white text-lg cursor-pointer hover:bg-emerald-700 capitalize"
                        >
                            sign up
                        </Link>
                    </motion.div>
